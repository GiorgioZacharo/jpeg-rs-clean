...
proc create_root_design { parentCell } {
  ...
  # Create instance: decode_start_f2r_vectorPh_s2e_forBody96Preheader_0, and set properties
  set decode_start_f2r_vectorPh_s2e_forBody96Preheader_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:decode_start_f2r_vectorPh_s2e_forBody96Preheader:1.0 decode_start_f2r_vectorPh_s2e_forBody96Preheader_0 ]

  set_property -dict [ list \
   CONFIG.NUM_READ_OUTSTANDING {1} \
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /decode_start_f2r_vectorPh_s2e_forBody96Preheader_0/s_axi_BUS_CTRL]
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces decode_start_f2r_vectorPh_s2e_forBody96Preheader_0/Data_m_axi_BUS_SRC] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces decode_start_f2r_vectorPh_s2e_forBody96Preheader_0/Data_m_axi_BUS_DST] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
