...
// Date        : Thu May 17 18:15:31 2018
// Host        : legolas running 64-bit CentOS Linux release 7.3.1611 (Core)
// Command     : write_verilog -force -mode synth_stub
//               /home/giorgio/workspace/jpeg-rs-clean/sys/jpeg-rs/jpeg-rs.srcs/sources_1/bd/design_1/ip/design_1_IQuantize_0_1/design_1_IQuantize_0_1_stub.v
// Design      : design_1_IQuantize_0_1
...
module design_1_IQuantize_0_1(s_axi_BUS_CTRL_AWADDR, 
  ...
  s_axi_BUS_CTRL_RREADY, ap_clk, ap_rst_n, interrupt, m_axi_BUS_DST_AWADDR, 
  m_axi_BUS_DST_AWLEN, m_axi_BUS_DST_AWSIZE, m_axi_BUS_DST_AWBURST, m_axi_BUS_DST_AWLOCK, 
  m_axi_BUS_DST_AWREGION, m_axi_BUS_DST_AWCACHE, m_axi_BUS_DST_AWPROT, 
  m_axi_BUS_DST_AWQOS, m_axi_BUS_DST_AWVALID, m_axi_BUS_DST_AWREADY, m_axi_BUS_DST_WDATA, 
  m_axi_BUS_DST_WSTRB, m_axi_BUS_DST_WLAST, m_axi_BUS_DST_WVALID, m_axi_BUS_DST_WREADY, 
  m_axi_BUS_DST_BRESP, m_axi_BUS_DST_BVALID, m_axi_BUS_DST_BREADY, m_axi_BUS_DST_ARADDR, 
  m_axi_BUS_DST_ARLEN, m_axi_BUS_DST_ARSIZE, m_axi_BUS_DST_ARBURST, m_axi_BUS_DST_ARLOCK, 
  m_axi_BUS_DST_ARREGION, m_axi_BUS_DST_ARCACHE, m_axi_BUS_DST_ARPROT, 
  m_axi_BUS_DST_ARQOS, m_axi_BUS_DST_ARVALID, m_axi_BUS_DST_ARREADY, m_axi_BUS_DST_RDATA, 
  m_axi_BUS_DST_RRESP, m_axi_BUS_DST_RLAST, m_axi_BUS_DST_RVALID, m_axi_BUS_DST_RREADY, 
  m_axi_BUS_SRC_AWADDR, m_axi_BUS_SRC_AWLEN, m_axi_BUS_SRC_AWSIZE, m_axi_BUS_SRC_AWBURST, 
  m_axi_BUS_SRC_AWLOCK, m_axi_BUS_SRC_AWREGION, m_axi_BUS_SRC_AWCACHE, 
  m_axi_BUS_SRC_AWPROT, m_axi_BUS_SRC_AWQOS, m_axi_BUS_SRC_AWVALID, 
  m_axi_BUS_SRC_AWREADY, m_axi_BUS_SRC_WDATA, m_axi_BUS_SRC_WSTRB, m_axi_BUS_SRC_WLAST, 
  m_axi_BUS_SRC_WVALID, m_axi_BUS_SRC_WREADY, m_axi_BUS_SRC_BRESP, m_axi_BUS_SRC_BVALID, 
  m_axi_BUS_SRC_BREADY, m_axi_BUS_SRC_ARADDR, m_axi_BUS_SRC_ARLEN, m_axi_BUS_SRC_ARSIZE, 
  m_axi_BUS_SRC_ARBURST, m_axi_BUS_SRC_ARLOCK, m_axi_BUS_SRC_ARREGION, 
  m_axi_BUS_SRC_ARCACHE, m_axi_BUS_SRC_ARPROT, m_axi_BUS_SRC_ARQOS, 
  m_axi_BUS_SRC_ARVALID, m_axi_BUS_SRC_ARREADY, m_axi_BUS_SRC_RDATA, m_axi_BUS_SRC_RRESP, 
  m_axi_BUS_SRC_RLAST, m_axi_BUS_SRC_RVALID, m_axi_BUS_SRC_RREADY)
/* synthesis syn_black_box black_box_pad_pin="s_axi_BUS_CTRL_AWADDR[5:0],s_axi_BUS_CTRL_AWVALID,s_axi_BUS_CTRL_AWREADY,s_axi_BUS_CTRL_WDATA[31:0],s_axi_BUS_CTRL_WSTRB[3:0],s_axi_BUS_CTRL_WVALID,s_axi_BUS_CTRL_WREADY,s_axi_BUS_CTRL_BRESP[1:0],s_axi_BUS_CTRL_BVALID,s_axi_BUS_CTRL_BREADY,s_axi_BUS_CTRL_ARADDR[5:0],s_axi_BUS_CTRL_ARVALID,s_axi_BUS_CTRL_ARREADY,s_axi_BUS_CTRL_RDATA[31:0],s_axi_BUS_CTRL_RRESP[1:0],s_axi_BUS_CTRL_RVALID,s_axi_BUS_CTRL_RREADY,ap_clk,ap_rst_n,interrupt,m_axi_BUS_DST_AWADDR[63:0],m_axi_BUS_DST_AWLEN[7:0],m_axi_BUS_DST_AWSIZE[2:0],m_axi_BUS_DST_AWBURST[1:0],m_axi_BUS_DST_AWLOCK[1:0],m_axi_BUS_DST_AWREGION[3:0],m_axi_BUS_DST_AWCACHE[3:0],m_axi_BUS_DST_AWPROT[2:0],m_axi_BUS_DST_AWQOS[3:0],m_axi_BUS_DST_AWVALID,m_axi_BUS_DST_AWREADY,m_axi_BUS_DST_WDATA[31:0],m_axi_BUS_DST_WSTRB[3:0],m_axi_BUS_DST_WLAST,m_axi_BUS_DST_WVALID,m_axi_BUS_DST_WREADY,m_axi_BUS_DST_BRESP[1:0],m_axi_BUS_DST_BVALID,m_axi_BUS_DST_BREADY,m_axi_BUS_DST_ARADDR[63:0],m_axi_BUS_DST_ARLEN[7:0],m_axi_BUS_DST_ARSIZE[2:0],m_axi_BUS_DST_ARBURST[1:0],m_axi_BUS_DST_ARLOCK[1:0],m_axi_BUS_DST_ARREGION[3:0],m_axi_BUS_DST_ARCACHE[3:0],m_axi_BUS_DST_ARPROT[2:0],m_axi_BUS_DST_ARQOS[3:0],m_axi_BUS_DST_ARVALID,m_axi_BUS_DST_ARREADY,m_axi_BUS_DST_RDATA[31:0],m_axi_BUS_DST_RRESP[1:0],m_axi_BUS_DST_RLAST,m_axi_BUS_DST_RVALID,m_axi_BUS_DST_RREADY,m_axi_BUS_SRC_AWADDR[63:0],m_axi_BUS_SRC_AWLEN[7:0],m_axi_BUS_SRC_AWSIZE[2:0],m_axi_BUS_SRC_AWBURST[1:0],m_axi_BUS_SRC_AWLOCK[1:0],m_axi_BUS_SRC_AWREGION[3:0],m_axi_BUS_SRC_AWCACHE[3:0],m_axi_BUS_SRC_AWPROT[2:0],m_axi_BUS_SRC_AWQOS[3:0],m_axi_BUS_SRC_AWVALID,m_axi_BUS_SRC_AWREADY,m_axi_BUS_SRC_WDATA[31:0],m_axi_BUS_SRC_WSTRB[3:0],m_axi_BUS_SRC_WLAST,m_axi_BUS_SRC_WVALID,m_axi_BUS_SRC_WREADY,m_axi_BUS_SRC_BRESP[1:0],m_axi_BUS_SRC_BVALID,m_axi_BUS_SRC_BREADY,m_axi_BUS_SRC_ARADDR[63:0],m_axi_BUS_SRC_ARLEN[7:0],m_axi_BUS_SRC_ARSIZE[2:0],m_axi_BUS_SRC_ARBURST[1:0],m_axi_BUS_SRC_ARLOCK[1:0],m_axi_BUS_SRC_ARREGION[3:0],m_axi_BUS_SRC_ARCACHE[3:0],m_axi_BUS_SRC_ARPROT[2:0],m_axi_BUS_SRC_ARQOS[3:0],m_axi_BUS_SRC_ARVALID,m_axi_BUS_SRC_ARREADY,m_axi_BUS_SRC_RDATA[31:0],m_axi_BUS_SRC_RRESP[1:0],m_axi_BUS_SRC_RLAST,m_axi_BUS_SRC_RVALID,m_axi_BUS_SRC_RREADY" */;
