...
#pragma line 112 "../src/chenidct.c"
void
...
#pragma line 270 "../src/chenidct.c"
  int inp1_buf[32];
  int out1_buf[32];
#pragma empty_line
#pragma HLS ARRAY_PARTITION variable=inp1_buf cyclic factor=16 dim=1
...
#pragma empty_line
 for (i = 0; i < 64/32; i++){
#pragma line 286 "../src/chenidct.c"
        unsigned offset = i*32;
        memcpy(inp1_buf, y + offset, 32 * sizeof(int));
#pragma empty_line
#pragma empty_line
...
#pragma HLS UNROLL skip_exit_check factor=16
 out1_buf[k] = (((inp1_buf[k] < 0) ? (inp1_buf[k] - 8) : (inp1_buf[k] + 8)) / 16);
#pragma line 303 "../src/chenidct.c"
      offset = i*32;
      memcpy(y + offset, out1_buf, 32 * sizeof(int));
#pragma empty_line
#pragma empty_line
