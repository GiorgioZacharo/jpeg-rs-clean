...
module AESL_axi_master_BUS_SRC (
    ...
    TRAN_BUS_SRC_BID,
    TRAN_BUS_SRC_BUSER,
    TRAN_BUS_SRC_imatrix,
    ready,
    done
    );

//------------------------Parameter----------------------
`define TV_IN_BUS_SRC "../tv/cdatafile/c.IZigzagMatrix_f2r_forBody_s2e_forEnd.autotvin_BUS_SRC.dat"
`define TV_OUT_BUS_SRC "../tv/rtldatafile/rtl.IZigzagMatrix_f2r_forBody_s2e_forEnd.autotvout_BUS_SRC.dat"
 parameter BUS_SRC_ADDR_BITWIDTH = 32'd 32;
...
output [32 - 1 : 0] TRAN_BUS_SRC_imatrix;
input ready;
input done;
...
assign    TRAN_BUS_SRC_imatrix = imatrix;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > BUS_SRC_mem_depth) begin
                $display ("/home/giorgio/workspace/jpeg-rs-clean/syn/Izigzagmatrix/OPT/sim/verilog/AESL_axi_master_BUS_SRC.v: Write request address %d exceed AXI master BUS_SRC array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, BUS_SRC_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > BUS_SRC_mem_depth) begin
                $display ("/home/giorgio/workspace/jpeg-rs-clean/syn/Izigzagmatrix/OPT/sim/verilog/AESL_axi_master_BUS_SRC.v: Read request address %d exceed AXI master BUS_SRC array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, BUS_SRC_mem_depth); 
                $finish;
            end
