...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.IZigzagMatrix_f2r_forBody_s2e_forEnd.autotvin_BUS_SRC.dat"
         "c.IZigzagMatrix_f2r_forBody_s2e_forEnd.autotvin_imatrix.dat"
         "c.IZigzagMatrix_f2r_forBody_s2e_forEnd.autotvin_omatrix.dat"
         "c.IZigzagMatrix_f2r_forBody_s2e_forEnd.autotvout_BUS_DST.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.IZigzagMatrix_f2r_forBody_s2e_forEnd.autotvout_BUS_DST.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
