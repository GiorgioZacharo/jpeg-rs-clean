...
module AESL_axi_master_BUS_DST (
    ...
    TRAN_BUS_DST_BID,
    TRAN_BUS_DST_BUSER,
    TRAN_BUS_DST_omatrix,
    ready,
    done
    );

//------------------------Parameter----------------------
`define TV_IN_BUS_DST "../tv/cdatafile/c.IZigzagMatrix_f2r_forBody_s2e_forEnd.autotvin_BUS_DST.dat"
`define TV_OUT_BUS_DST "../tv/rtldatafile/rtl.IZigzagMatrix_f2r_forBody_s2e_forEnd.autotvout_BUS_DST.dat"
 parameter BUS_DST_ADDR_BITWIDTH = 32'd 32;
...
parameter BUS_DST_mem_depth = 32'd 64;
...
output [32 - 1 : 0] TRAN_BUS_DST_omatrix;
input ready;
input done;
...
assign    TRAN_BUS_DST_omatrix = omatrix;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > BUS_DST_mem_depth) begin
                $display ("/home/giorgio/workspace/jpeg-rs-clean/syn/Izigzagmatrix/OPT/sim/verilog/AESL_axi_master_BUS_DST.v: Write request address %d exceed AXI master BUS_DST array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, BUS_DST_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > BUS_DST_mem_depth) begin
                $display ("/home/giorgio/workspace/jpeg-rs-clean/syn/Izigzagmatrix/OPT/sim/verilog/AESL_axi_master_BUS_DST.v: Read request address %d exceed AXI master BUS_DST array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, BUS_DST_mem_depth); 
                $finish;
            end
