...
#pragma line 316 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
void
WriteBlock (int *store, int *p_out_vpos, int *p_out_hpos,
     unsigned char *p_out_buf)
{
...
#pragma empty_line
  for (int i = 0; i < 64/32; i++) {
#pragma line 461 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        unsigned offset = i*32 ;
...
#pragma line 502 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        offset = i*32 ;
...
#pragma empty_line
      for (i = 0; i < 64/32; i++)
      {
#pragma line 557 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        unsigned offset = i*32;
...
#pragma line 598 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        offset = i*32;
        memcpy(rgb_buf[p][0] + offset, out1_buf, 32 * sizeof(int));
        memcpy(rgb_buf[p][1] + offset, out2_buf, 32 * sizeof(int));
        memcpy(rgb_buf[p][2] + offset, out3_buf, 32 * sizeof(int));
...
#pragma line 738 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
