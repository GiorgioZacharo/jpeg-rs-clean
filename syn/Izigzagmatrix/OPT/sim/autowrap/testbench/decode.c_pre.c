...
# 316 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
void
WriteBlock (int *store, int *p_out_vpos, int *p_out_hpos,
     unsigned char *p_out_buf)
{
...
#pragma HLS ARRAY_PARTITION variable=out3_buf cyclic factor=16 dim=1
  ...
  for (int i = 0; i < 64/32; i++) {
# 461 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        unsigned offset = i*32 ;
...
# 502 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        offset = i*32 ;
...
#pragma HLS ARRAY_PARTITION variable=out3_buf cyclic factor=16 dim=1
      ...
      for (i = 0; i < 64/32; i++)
      {
# 557 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        unsigned offset = i*32;
...
# 598 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        offset = i*32;
        memcpy(rgb_buf[p][0] + offset, out1_buf, 32 * sizeof(int));
        memcpy(rgb_buf[p][1] + offset, out2_buf, 32 * sizeof(int));
        memcpy(rgb_buf[p][2] + offset, out3_buf, 32 * sizeof(int));
...
# 738 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
