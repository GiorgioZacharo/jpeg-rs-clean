...
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module Loop_0_proc19_zigbkb_rom (
...
initial begin
    $readmemh("./Loop_0_proc19_zigbkb_rom.dat", ram0);
    $readmemh("./Loop_0_proc19_zigbkb_rom.dat", ram1);
    $readmemh("./Loop_0_proc19_zigbkb_rom.dat", ram2);
    $readmemh("./Loop_0_proc19_zigbkb_rom.dat", ram3);
    $readmemh("./Loop_0_proc19_zigbkb_rom.dat", ram4);
    $readmemh("./Loop_0_proc19_zigbkb_rom.dat", ram5);
    $readmemh("./Loop_0_proc19_zigbkb_rom.dat", ram6);
    $readmemh("./Loop_0_proc19_zigbkb_rom.dat", ram7);
end
...
Loop_0_proc19_zigbkb_rom Loop_0_proc19_zigbkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
