...
void dataflow_in_loop_tde::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void dataflow_in_loop_tde::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void dataflow_in_loop_tde::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void dataflow_in_loop_tde::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
