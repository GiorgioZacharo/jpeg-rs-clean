...
set Library     "hls"
set IPName      "IZigzagMatrix_f2r_forBody_s2e_forEnd"
set Version     "1.0"
set DisplayName "Izigzagmatrix_f2r_forbody_s2e_forend"
set Revision    "1805171750"
...
## Variables
set Top "IZigzagMatrix_f2r_forBody_s2e_forEnd"
...
set Interfaces {
    s_axi_BUS_CTRL {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 imatrix_1 W 0x0 "Data signal of imatrix" {{0 32 imatrix W 0 "Bit 31 to 0 Data signal of imatrix"}}} {0x14 imatrix_2 W 0x0 "Data signal of imatrix" {{0 32 imatrix W 0 "Bit 63 to 32 Data signal of imatrix"}}} {0x1c omatrix_1 W 0x0 "Data signal of omatrix" {{0 32 omatrix W 0 "Bit 31 to 0 Data signal of omatrix"}}} {0x20 omatrix_2 W 0x0 "Data signal of omatrix" {{0 32 omatrix W 0 "Bit 63 to 32 Data signal of omatrix"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 3 machine 64 combinational 0 latency 156 II x}
