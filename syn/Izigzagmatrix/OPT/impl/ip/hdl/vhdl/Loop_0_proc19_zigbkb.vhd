...
entity Loop_0_proc19_zigbkb_rom is 
    generic(
             dwidth     : integer := 6; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of Loop_0_proc19_zigbkb_rom is 
...
entity Loop_0_proc19_zigbkb is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of Loop_0_proc19_zigbkb is
    component Loop_0_proc19_zigbkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Loop_0_proc19_zigbkb_rom_U :  component Loop_0_proc19_zigbkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
