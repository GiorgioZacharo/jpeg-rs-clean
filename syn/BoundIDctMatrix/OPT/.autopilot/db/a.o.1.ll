; ModuleID = '/home/giorgio/workspace/jpeg-rs-clean/syn/BoundIDctMatrix/OPT/.autopilot/db/a.g.1.bc'
...
define void @BoundIDctMatrix(i32* %matrix, i32 %Bound) nounwind uwtable {
  ...
  %inp1_buf = alloca [32 x i32], align 16         ; [#uses=4 type=[32 x i32]*]
  %out1_buf = alloca [32 x i32], align 16         ; [#uses=1 type=[32 x i32]*]
  call void @llvm.dbg.value(metadata !{i32* %matrix}, i64 0, metadata !208), !dbg !209 ; [debug line = 234:22] [debug variable = matrix]
  call void @llvm.dbg.value(metadata !{i32 %Bound}, i64 0, metadata !210), !dbg !211 ; [debug line = 234:38] [debug variable = Bound]
  call void (...)* @_ssdm_SpecArrayDimSize(i32* %matrix, i32 64) nounwind, !dbg !212 ; [debug line = 234:46]
  call void (...)* @_ssdm_op_SpecInterface(i32* %matrix, i8* getelementptr inbounds ([6 x i8]* @.str8, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0), i32 0, i32 64, i8* getelementptr inbounds ([8 x i8]* @.str412, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str311, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0), i32 16, i32 16, i32 16, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0)) nounwind, !dbg !214 ; [debug line = 235:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %Bound, i8* getelementptr inbounds ([10 x i8]* @.str513, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str210, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0)) nounwind, !dbg !215 ; [debug line = 236:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str513, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([9 x i8]* @.str614, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0)) nounwind, !dbg !216 ; [debug line = 237:1]
  call void @llvm.dbg.declare(metadata !{[32 x i32]* %inp1_buf}, metadata !217), !dbg !219 ; [debug line = 240:6] [debug variable = inp1_buf]
  call void @llvm.dbg.declare(metadata !{[32 x i32]* %out1_buf}, metadata !220), !dbg !221 ; [debug line = 241:6] [debug variable = out1_buf]
  %inp1_buf.addr = getelementptr inbounds [32 x i32]* %inp1_buf, i64 0, i64 0, !dbg !222 ; [#uses=1 type=i32*] [debug line = 243:1]
  call void (...)* @_ssdm_SpecArrayPartition(i32* %inp1_buf.addr, i32 1, i8* getelementptr inbounds ([7 x i8]* @.str715, i64 0, i64 0), i32 16, i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0)) nounwind, !dbg !222 ; [debug line = 243:1]
  %out1_buf.addr = getelementptr inbounds [32 x i32]* %out1_buf, i64 0, i64 0, !dbg !223 ; [#uses=1 type=i32*] [debug line = 244:1]
  call void (...)* @_ssdm_SpecArrayPartition(i32* %out1_buf.addr, i32 1, i8* getelementptr inbounds ([7 x i8]* @.str715, i64 0, i64 0), i32 16, i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0)) nounwind, !dbg !223 ; [debug line = 244:1]
  br label %1, !dbg !224                          ; [debug line = 246:7]

; <label>:1                                       ; preds = %memcpy.tail, %0
  %i = phi i32 [ 0, %0 ], [ %i.1, %memcpy.tail ]  ; [#uses=3 type=i32]
  %exitcond1 = icmp eq i32 %i, 2, !dbg !224       ; [#uses=1 type=i1] [debug line = 246:7]
  br i1 %exitcond1, label %14, label %2, !dbg !224 ; [debug line = 246:7]

; <label>:2                                       ; preds = %1
  %offset = shl nsw i32 %i, 5, !dbg !226          ; [#uses=3 type=i32] [debug line = 254:26]
  call void @llvm.dbg.value(metadata !{i32 %offset}, i64 0, metadata !228), !dbg !229 ; [debug line = 278:2] [debug variable = offset]
  call void @llvm.dbg.value(metadata !{i32 %offset}, i64 0, metadata !228), !dbg !226 ; [debug line = 254:26] [debug variable = offset]
  %tmp = zext i32 %offset to i64, !dbg !230       ; [#uses=1 type=i64] [debug line = 255:4]
  %matrix.addr.1 = getelementptr inbounds i32* %matrix, i64 %tmp, !dbg !230 ; [#uses=2 type=i32*] [debug line = 255:4]
...
burst.rd.end.preheader:                           ; preds = %burst.rd.header
  br label %burst.rd.end, !dbg !231               ; [debug line = 260:15]

burst.rd.body:                                    ; preds = %burst.rd.header
  %burstread.rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin([17 x i8]* @burstread_OC_region.str) nounwind ; [#uses=1 type=i32]
  %3 = call i32 (...)* @_ssdm_op_SpecBurst(i32* %matrix.addr.1, i32 1, i32 32, i32 1) nounwind ; [#uses=0 type=i32]
  %4 = call i32 (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str) nounwind ; [#uses=0 type=i32]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopName([23 x i8]* @memcpy_OC_inp1_buf_OC_matrix.str) nounwind ; [#uses=0 type=i32]
  %indvar.next = add i32 %indvar, 1               ; [#uses=1 type=i32]
  %matrix.addr = add i32 %indvar, %offset         ; [#uses=1 type=i32]
  %tmp.1 = sext i32 %matrix.addr to i64, !dbg !230 ; [#uses=1 type=i64] [debug line = 255:4]
  %matrix.addr.2 = getelementptr i32* %matrix, i64 %tmp.1, !dbg !230 ; [#uses=1 type=i32*] [debug line = 255:4]
  %matrix.load = load i32* %matrix.addr.2, align 4, !dbg !230 ; [#uses=1 type=i32] [debug line = 255:4]
  %tmp.2 = sext i32 %indvar to i64, !dbg !230     ; [#uses=1 type=i64] [debug line = 255:4]
  %inp1_buf.addr.1 = getelementptr [32 x i32]* %inp1_buf, i64 0, i64 %tmp.2, !dbg !230 ; [#uses=1 type=i32*] [debug line = 255:4]
  store i32 %matrix.load, i32* %inp1_buf.addr.1, align 4, !dbg !230 ; [debug line = 255:4]
...
burst.rd.end:                                     ; preds = %10, %burst.rd.end.preheader
  %k = phi i32 [ %k.1, %10 ], [ 0, %burst.rd.end.preheader ] ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %k, 32, !dbg !231       ; [#uses=1 type=i1] [debug line = 260:15]
  br i1 %exitcond, label %burst.wr.header.preheader, label %6, !dbg !231 ; [debug line = 260:15]

burst.wr.header.preheader:                        ; preds = %burst.rd.end
  br label %burst.wr.header

; <label>:6                                       ; preds = %burst.rd.end
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str12, i64 0, i64 0)) nounwind, !dbg !233 ; [#uses=1 type=i32] [debug line = 260:30]
  call void (...)* @_ssdm_Unroll(i32 1, i32 4, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str19, i64 0, i64 0)) nounwind, !dbg !235 ; [debug line = 261:1]
  %tmp.3 = sext i32 %k to i64, !dbg !236          ; [#uses=1 type=i64] [debug line = 262:2]
  %inp1_buf.addr.2 = getelementptr inbounds [32 x i32]* %inp1_buf, i64 0, i64 %tmp.3, !dbg !236 ; [#uses=3 type=i32*] [debug line = 262:2]
  %inp1_buf.load = load i32* %inp1_buf.addr.2, align 4, !dbg !236 ; [#uses=4 type=i32] [debug line = 262:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %inp1_buf.load) nounwind
  %tmp.4 = icmp slt i32 %inp1_buf.load, 0, !dbg !236 ; [#uses=1 type=i1] [debug line = 262:2]
  br i1 %tmp.4, label %7, label %8, !dbg !236     ; [debug line = 262:2]

; <label>:7                                       ; preds = %6
  store i32 0, i32* %inp1_buf.addr.2, align 4, !dbg !237 ; [debug line = 263:5]
  br label %10, !dbg !237                         ; [debug line = 263:5]

; <label>:8                                       ; preds = %6
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %inp1_buf.load) nounwind
  %tmp.5 = icmp sgt i32 %inp1_buf.load, %Bound, !dbg !238 ; [#uses=1 type=i1] [debug line = 265:9]
  br i1 %tmp.5, label %9, label %._crit_edge, !dbg !238 ; [debug line = 265:9]

; <label>:9                                       ; preds = %8
  store i32 %Bound, i32* %inp1_buf.addr.2, align 4, !dbg !239 ; [debug line = 266:5]
  br label %._crit_edge, !dbg !239                ; [debug line = 266:5]

._crit_edge:                                      ; preds = %9, %8
  br label %10

; <label>:10                                      ; preds = %._crit_edge, %7
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str12, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !240 ; [#uses=0 type=i32] [debug line = 267:3]
  %k.1 = add nsw i32 %k, 1, !dbg !241             ; [#uses=1 type=i32] [debug line = 260:25]
  call void @llvm.dbg.value(metadata !{i32 %k.1}, i64 0, metadata !242), !dbg !241 ; [debug line = 260:25] [debug variable = k]
  br label %burst.rd.end, !dbg !241               ; [debug line = 260:25]

burst.wr.header:                                  ; preds = %burst.wr.body, %burst.wr.header.preheader
  %indvar6 = phi i32 [ %indvar.next7, %burst.wr.body ], [ 0, %burst.wr.header.preheader ] ; [#uses=4 type=i32]
  %exitcond8 = icmp eq i32 %indvar6, 32           ; [#uses=1 type=i1]
...
burst.wr.body:                                    ; preds = %burst.wr.header
  ...
  %11 = call i32 (...)* @_ssdm_op_SpecBurst(i32* %matrix.addr.1, i32 0, i32 32, i32 1) nounwind ; [#uses=0 type=i32]
  %12 = call i32 (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str) nounwind ; [#uses=0 type=i32]
  %13 = call i32 (...)* @_ssdm_op_SpecLoopName([27 x i8]* @memcpy_OC_matrix_OC_inp1_buf_OC_gep.str) nounwind ; [#uses=0 type=i32]
  %indvar.next7 = add i32 %indvar6, 1             ; [#uses=1 type=i32]
  %tmp.7 = sext i32 %indvar6 to i64, !dbg !243    ; [#uses=1 type=i64] [debug line = 279:5]
  %inp1_buf.addr.3 = getelementptr [32 x i32]* %inp1_buf, i64 0, i64 %tmp.7, !dbg !243 ; [#uses=1 type=i32*] [debug line = 279:5]
  %inp1_buf.load.1 = load i32* %inp1_buf.addr.3, align 4, !dbg !243 ; [#uses=1 type=i32] [debug line = 279:5]
  %matrix.addr3 = add i32 %indvar6, %offset       ; [#uses=1 type=i32]
  %tmp.8 = sext i32 %matrix.addr3 to i64, !dbg !243 ; [#uses=1 type=i64] [debug line = 279:5]
  %matrix.addr.4 = getelementptr i32* %matrix, i64 %tmp.8, !dbg !243 ; [#uses=1 type=i32*] [debug line = 279:5]
  store i32 %inp1_buf.load.1, i32* %matrix.addr.4, align 4, !dbg !243 ; [debug line = 279:5]
...
memcpy.tail:                                      ; preds = %burst.wr.header
  %i.1 = add nsw i32 %i, 1, !dbg !244             ; [#uses=1 type=i32] [debug line = 246:25]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !245), !dbg !244 ; [debug line = 246:25] [debug variable = i]
  br label %1, !dbg !244                          ; [debug line = 246:25]

; <label>:14                                      ; preds = %1
  ret void, !dbg !246                             ; [debug line = 283:1]
}
...
!81 = metadata !{i32 786478, i32 0, metadata !73, metadata !"BoundIDctMatrix", metadata !"BoundIDctMatrix", metadata !"", metadata !73, i32 234, metadata !79, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32*, i32)* @BoundIDctMatrix, null, null, metadata !11, i32 234} ; [ DW_TAG_subprogram ]
...
!170 = metadata !{void (i32*, i32)* @BoundIDctMatrix, metadata !167, metadata !157, metadata !168, metadata !159, metadata !171, metadata !154}
...
!208 = metadata !{i32 786689, metadata !81, metadata !"matrix", metadata !73, i32 16777450, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!209 = metadata !{i32 234, i32 22, metadata !81, null}
!210 = metadata !{i32 786689, metadata !81, metadata !"Bound", metadata !73, i32 33554666, metadata !10, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!211 = metadata !{i32 234, i32 38, metadata !81, null}
!212 = metadata !{i32 234, i32 46, metadata !213, null}
!213 = metadata !{i32 786443, metadata !81, i32 234, i32 45, metadata !73, i32 15} ; [ DW_TAG_lexical_block ]
!214 = metadata !{i32 235, i32 1, metadata !213, null}
!215 = metadata !{i32 236, i32 1, metadata !213, null}
!216 = metadata !{i32 237, i32 1, metadata !213, null}
!217 = metadata !{i32 786688, metadata !213, metadata !"inp1_buf", metadata !73, i32 240, metadata !218, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!218 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 32, i32 0, i32 0, metadata !10, metadata !133, i32 0, i32 0} ; [ DW_TAG_array_type ]
!219 = metadata !{i32 240, i32 6, metadata !213, null}
!220 = metadata !{i32 786688, metadata !213, metadata !"out1_buf", metadata !73, i32 241, metadata !218, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!221 = metadata !{i32 241, i32 6, metadata !213, null}
!222 = metadata !{i32 243, i32 1, metadata !213, null}
!223 = metadata !{i32 244, i32 1, metadata !213, null}
!224 = metadata !{i32 246, i32 7, metadata !225, null}
!225 = metadata !{i32 786443, metadata !213, i32 246, i32 2, metadata !73, i32 16} ; [ DW_TAG_lexical_block ]
!226 = metadata !{i32 254, i32 26, metadata !227, null}
!227 = metadata !{i32 786443, metadata !225, i32 246, i32 29, metadata !73, i32 17} ; [ DW_TAG_lexical_block ]
!228 = metadata !{i32 786688, metadata !227, metadata !"offset", metadata !73, i32 254, metadata !38, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!229 = metadata !{i32 278, i32 2, metadata !227, null}
!230 = metadata !{i32 255, i32 4, metadata !227, null}
!231 = metadata !{i32 260, i32 15, metadata !232, null}
!232 = metadata !{i32 786443, metadata !227, i32 260, i32 3, metadata !73, i32 18} ; [ DW_TAG_lexical_block ]
!233 = metadata !{i32 260, i32 30, metadata !234, null}
!234 = metadata !{i32 786443, metadata !232, i32 260, i32 29, metadata !73, i32 19} ; [ DW_TAG_lexical_block ]
!235 = metadata !{i32 261, i32 1, metadata !234, null}
!236 = metadata !{i32 262, i32 2, metadata !234, null}
!237 = metadata !{i32 263, i32 5, metadata !234, null}
!238 = metadata !{i32 265, i32 9, metadata !234, null}
!239 = metadata !{i32 266, i32 5, metadata !234, null}
!240 = metadata !{i32 267, i32 3, metadata !234, null}
!241 = metadata !{i32 260, i32 25, metadata !232, null}
!242 = metadata !{i32 786688, metadata !232, metadata !"k", metadata !73, i32 260, metadata !10, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!243 = metadata !{i32 279, i32 5, metadata !227, null}
!244 = metadata !{i32 246, i32 25, metadata !225, null}
!245 = metadata !{i32 786688, metadata !213, metadata !"i", metadata !73, i32 239, metadata !10, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!246 = metadata !{i32 283, i32 1, metadata !213, null}
