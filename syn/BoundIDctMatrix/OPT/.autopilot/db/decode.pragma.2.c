# 1 "/home/giorgio/workspace/jpeg-rs-clean/syn/BoundIDctMatrix/OPT/.autopilot/db/decode.pragma.1.c"
# 1 "/home/giorgio/workspace/jpeg-rs-clean/syn/BoundIDctMatrix/OPT/.autopilot/db/decode.pragma.1.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "/home/giorgio/workspace/jpeg-rs-clean/syn/BoundIDctMatrix/OPT/.autopilot/db/decode.pragma.1.c" 2
# 1 "../src/decode.c"
# 1 "../src/decode.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
