# 1 "/home/giorgio/workspace/jpeg-rs-clean/syn/BoundIDctMatrix/OPT/.autopilot/db/chenidct.pragma.1.c"
# 1 "/home/giorgio/workspace/jpeg-rs-clean/syn/BoundIDctMatrix/OPT/.autopilot/db/chenidct.pragma.1.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
...
# 7 "<command line>" 2
# 1 "<built-in>" 2
# 1 "/home/giorgio/workspace/jpeg-rs-clean/syn/BoundIDctMatrix/OPT/.autopilot/db/chenidct.pragma.1.c" 2
# 1 "../src/chenidct.c"
# 1 "../src/chenidct.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
