...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.BoundIDctMatrix.autotvin_BUS_DST.dat"
         "c.BoundIDctMatrix.autotvin_matrix.dat"
         "c.BoundIDctMatrix.autotvin_Bound.dat"
         "c.BoundIDctMatrix.autotvout_BUS_DST.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.BoundIDctMatrix.autotvout_BUS_DST.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
