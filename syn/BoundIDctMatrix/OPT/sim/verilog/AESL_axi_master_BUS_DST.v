...
//------------------------Parameter----------------------
`define TV_IN_BUS_DST "../tv/cdatafile/c.BoundIDctMatrix.autotvin_BUS_DST.dat"
`define TV_OUT_BUS_DST "../tv/rtldatafile/rtl.BoundIDctMatrix.autotvout_BUS_DST.dat"
...
output [32 - 1 : 0] TRAN_BUS_DST_matrix;
input ready;
input done;
...
assign    TRAN_BUS_DST_matrix = matrix;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > BUS_DST_mem_depth) begin
                $display ("/home/giorgio/workspace/jpeg-rs-clean/syn/BoundIDctMatrix/OPT/sim/verilog/AESL_axi_master_BUS_DST.v: Write request address %d exceed AXI master BUS_DST array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, BUS_DST_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > BUS_DST_mem_depth) begin
                $display ("/home/giorgio/workspace/jpeg-rs-clean/syn/BoundIDctMatrix/OPT/sim/verilog/AESL_axi_master_BUS_DST.v: Read request address %d exceed AXI master BUS_DST array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, BUS_DST_mem_depth); 
                $finish;
            end
