...
#pragma line 202 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
void
...
#pragma line 247 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
    offset = i*32;
...
#pragma line 368 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
void
WriteBlock (int *store, int *p_out_vpos, int *p_out_hpos,
     unsigned char *p_out_buf)
{
...
#pragma line 471 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
void
...
#pragma empty_line
  voffs = *p_out_vpos * 8;
  hoffs = *p_out_hpos * 8;
#pragma line 506 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
    int i=0;
     int l=0;
     int j, k, m;
#pragma empty_line
...
#pragma empty_line
  voffs += 8;
  hoffs -= 8;
#pragma line 638 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
  i=0;
  l=0;
#pragma empty_line
...
#pragma empty_line
  hoffs += 8;
#pragma line 707 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
  i=0;
  l=0;
#pragma empty_line
...
#pragma line 846 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
...
#pragma empty_line
  for (int i = 0; i < 64/32; i++) {
#pragma line 885 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        unsigned offset = i*32 ;
...
#pragma line 926 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        offset = i*32 ;
...
#pragma empty_line
      for (i = 0; i < 64/32; i++)
      {
#pragma line 981 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        unsigned offset = i*32;
...
#pragma line 1022 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        offset = i*32;
        memcpy(rgb_buf[p][0] + offset, out1_buf, 32 * sizeof(int));
        memcpy(rgb_buf[p][1] + offset, out2_buf, 32 * sizeof(int));
        memcpy(rgb_buf[p][2] + offset, out3_buf, 32 * sizeof(int));
...
#pragma line 1162 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
