...
set Library     "hls"
set IPName      "BoundIDctMatrix"
set Version     "1.0"
set DisplayName "Boundidctmatrix"
set Revision    "1805171739"
...
set Interfaces {
    ...
    s_axi_BUS_SRC {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_BUS_SRC"
        param_prefix "C_S_AXI_BUS_SRC"
        addr_bits "5"
        port_width "AWADDR 5 WDATA 32 WSTRB 4 ARADDR 5 RDATA 32"
        registers {{0x10 Bound W 0x0 "Data signal of Bound" {{0 32 Bound W 0 "Bit 31 to 0 Data signal of Bound"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_BUS_CTRL s_axi_BUS_SRC m_axi_BUS_DST"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 3 machine 64 combinational 0 latency 160 II x}
