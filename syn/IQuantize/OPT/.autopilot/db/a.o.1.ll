...
define void @IQuantize(i32* %matrix, i32* %qmatrix) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32* %qmatrix, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 64, i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 16, i32 16, i32 16, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !212 ; [debug line = 166:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %matrix, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 64, i8* getelementptr inbounds ([8 x i8]* @.str4, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 16, i32 16, i32 16, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !214 ; [debug line = 167:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str5, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([9 x i8]* @.str6, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !215 ; [debug line = 168:1]
  ...
  call void (...)* @_ssdm_SpecArrayPartition(i32* %inp1_buf.addr, i32 1, i8* getelementptr inbounds ([7 x i8]* @.str7, i64 0, i64 0), i32 16, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !221 ; [debug line = 174:1]
  %inp2_buf.addr = getelementptr inbounds [32 x i32]* %inp2_buf, i64 0, i64 0, !dbg !222 ; [#uses=1 type=i32*] [debug line = 175:1]
  call void (...)* @_ssdm_SpecArrayPartition(i32* %inp2_buf.addr, i32 1, i8* getelementptr inbounds ([7 x i8]* @.str7, i64 0, i64 0), i32 16, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !222 ; [debug line = 175:1]
...
; <label>:2                                       ; preds = %1
  %offset = shl nsw i32 %i, 5, !dbg !225          ; [#uses=4 type=i32] [debug line = 185:26]
  call void @llvm.dbg.value(metadata !{i32 %offset}, i64 0, metadata !227), !dbg !228 ; [debug line = 203:6] [debug variable = offset]
  call void @llvm.dbg.value(metadata !{i32 %offset}, i64 0, metadata !227), !dbg !225 ; [debug line = 185:26] [debug variable = offset]
  %tmp = zext i32 %offset to i64, !dbg !229       ; [#uses=2 type=i64] [debug line = 186:4]
  %qmatrix.addr.1 = getelementptr inbounds i32* %qmatrix, i64 %tmp, !dbg !229 ; [#uses=1 type=i32*] [debug line = 186:4]
...
burst.rd.body:                                    ; preds = %burst.rd.header
  ...
  %tmp.1 = sext i32 %qmatrix.addr to i64, !dbg !229 ; [#uses=1 type=i64] [debug line = 186:4]
  %qmatrix.addr.2 = getelementptr i32* %qmatrix, i64 %tmp.1, !dbg !229 ; [#uses=1 type=i32*] [debug line = 186:4]
  %qmatrix.load = load i32* %qmatrix.addr.2, align 4, !dbg !229 ; [#uses=1 type=i32] [debug line = 186:4]
  %tmp.2 = sext i32 %indvar to i64, !dbg !229     ; [#uses=1 type=i64] [debug line = 186:4]
  %inp1_buf.addr.1 = getelementptr [32 x i32]* %inp1_buf, i64 0, i64 %tmp.2, !dbg !229 ; [#uses=1 type=i32*] [debug line = 186:4]
  store i32 %qmatrix.load, i32* %inp1_buf.addr.1, align 4, !dbg !229 ; [debug line = 186:4]
...
burst.rd.end:                                     ; preds = %burst.rd.header
  %matrix.addr.1 = getelementptr inbounds i32* %matrix, i64 %tmp, !dbg !230 ; [#uses=2 type=i32*] [debug line = 187:4]
...
burst.rd.end5.preheader:                          ; preds = %burst.rd.header6
  br label %burst.rd.end5, !dbg !231              ; [debug line = 192:16]
...
burst.rd.body7:                                   ; preds = %burst.rd.header6
  ...
  %tmp.3 = sext i32 %matrix.addr to i64, !dbg !230 ; [#uses=1 type=i64] [debug line = 187:4]
  %matrix.addr.2 = getelementptr i32* %matrix, i64 %tmp.3, !dbg !230 ; [#uses=1 type=i32*] [debug line = 187:4]
  %matrix.load = load i32* %matrix.addr.2, align 4, !dbg !230 ; [#uses=1 type=i32] [debug line = 187:4]
  %tmp.4 = sext i32 %indvar8 to i64, !dbg !230    ; [#uses=1 type=i64] [debug line = 187:4]
  %inp2_buf.addr.1 = getelementptr [32 x i32]* %inp2_buf, i64 0, i64 %tmp.4, !dbg !230 ; [#uses=1 type=i32*] [debug line = 187:4]
  store i32 %matrix.load, i32* %inp2_buf.addr.1, align 4, !dbg !230 ; [debug line = 187:4]
...
burst.rd.end5:                                    ; preds = %9, %burst.rd.end5.preheader
  ...
  %exitcond = icmp eq i32 %k, 32, !dbg !231       ; [#uses=1 type=i1] [debug line = 192:16]
  br i1 %exitcond, label %burst.wr.header.preheader, label %9, !dbg !231 ; [debug line = 192:16]

burst.wr.header.preheader:                        ; preds = %burst.rd.end5
  br label %burst.wr.header

; <label>:9                                       ; preds = %burst.rd.end5
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str11, i64 0, i64 0)) nounwind, !dbg !233 ; [#uses=1 type=i32] [debug line = 192:31]
  call void (...)* @_ssdm_Unroll(i32 1, i32 4, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !235 ; [debug line = 193:1]
  %tmp.5 = sext i32 %k to i64, !dbg !236          ; [#uses=2 type=i64] [debug line = 194:2]
  %inp1_buf.addr.2 = getelementptr inbounds [32 x i32]* %inp1_buf, i64 0, i64 %tmp.5, !dbg !236 ; [#uses=1 type=i32*] [debug line = 194:2]
  %inp1_buf.load = load i32* %inp1_buf.addr.2, align 4, !dbg !236 ; [#uses=2 type=i32] [debug line = 194:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %inp1_buf.load) nounwind
  %inp2_buf.addr.2 = getelementptr inbounds [32 x i32]* %inp2_buf, i64 0, i64 %tmp.5, !dbg !236 ; [#uses=2 type=i32*] [debug line = 194:2]
  %inp2_buf.load = load i32* %inp2_buf.addr.2, align 4, !dbg !236 ; [#uses=2 type=i32] [debug line = 194:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %inp2_buf.load) nounwind
  %tmp.6 = mul nsw i32 %inp2_buf.load, %inp1_buf.load, !dbg !236 ; [#uses=1 type=i32] [debug line = 194:2]
  store i32 %tmp.6, i32* %inp2_buf.addr.2, align 4, !dbg !236 ; [debug line = 194:2]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str11, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !237 ; [#uses=0 type=i32] [debug line = 195:4]
  %k.1 = add nsw i32 %k, 1, !dbg !238             ; [#uses=1 type=i32] [debug line = 192:26]
  call void @llvm.dbg.value(metadata !{i32 %k.1}, i64 0, metadata !239), !dbg !238 ; [debug line = 192:26] [debug variable = k]
  br label %burst.rd.end5, !dbg !238              ; [debug line = 192:26]
...
burst.wr.body:                                    ; preds = %burst.wr.header
  ...
  %11 = call i32 (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str10) nounwind ; [#uses=0 type=i32]
  ...
  %tmp.9 = sext i32 %indvar1 to i64, !dbg !240    ; [#uses=1 type=i64] [debug line = 204:6]
  %inp2_buf.addr.3 = getelementptr [32 x i32]* %inp2_buf, i64 0, i64 %tmp.9, !dbg !240 ; [#uses=1 type=i32*] [debug line = 204:6]
  %inp2_buf.load.1 = load i32* %inp2_buf.addr.3, align 4, !dbg !240 ; [#uses=1 type=i32] [debug line = 204:6]
  %matrix.addr3 = add i32 %indvar1, %offset       ; [#uses=1 type=i32]
  %tmp.10 = sext i32 %matrix.addr3 to i64, !dbg !240 ; [#uses=1 type=i64] [debug line = 204:6]
  %matrix.addr.4 = getelementptr i32* %matrix, i64 %tmp.10, !dbg !240 ; [#uses=1 type=i32*] [debug line = 204:6]
  store i32 %inp2_buf.load.1, i32* %matrix.addr.4, align 4, !dbg !240 ; [debug line = 204:6]
...
; <label>:13                                      ; preds = %1
  ret void, !dbg !243                             ; [debug line = 208:1]
}
...
!216 = metadata !{i32 786688, metadata !213, metadata !"inp1_buf", metadata !6, i32 171, metadata !217, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!219 = metadata !{i32 786688, metadata !213, metadata !"inp2_buf", metadata !6, i32 172, metadata !217, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!224 = metadata !{i32 786443, metadata !213, i32 177, i32 2, metadata !6, i32 8} ; [ DW_TAG_lexical_block ]
!225 = metadata !{i32 185, i32 26, metadata !226, null}
!226 = metadata !{i32 786443, metadata !224, i32 177, i32 29, metadata !6, i32 9} ; [ DW_TAG_lexical_block ]
!227 = metadata !{i32 786688, metadata !226, metadata !"offset", metadata !6, i32 185, metadata !17, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!228 = metadata !{i32 203, i32 6, metadata !226, null}
!229 = metadata !{i32 186, i32 4, metadata !226, null}
!230 = metadata !{i32 187, i32 4, metadata !226, null}
!231 = metadata !{i32 192, i32 16, metadata !232, null}
!232 = metadata !{i32 786443, metadata !226, i32 192, i32 4, metadata !6, i32 10} ; [ DW_TAG_lexical_block ]
!233 = metadata !{i32 192, i32 31, metadata !234, null}
!234 = metadata !{i32 786443, metadata !232, i32 192, i32 30, metadata !6, i32 11} ; [ DW_TAG_lexical_block ]
!235 = metadata !{i32 193, i32 1, metadata !234, null}
!236 = metadata !{i32 194, i32 2, metadata !234, null}
!237 = metadata !{i32 195, i32 4, metadata !234, null}
!238 = metadata !{i32 192, i32 26, metadata !232, null}
!239 = metadata !{i32 786688, metadata !232, metadata !"k", metadata !6, i32 192, metadata !10, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!240 = metadata !{i32 204, i32 6, metadata !226, null}
!241 = metadata !{i32 177, i32 25, metadata !224, null}
!242 = metadata !{i32 786688, metadata !213, metadata !"i", metadata !6, i32 170, metadata !10, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!243 = metadata !{i32 208, i32 1, metadata !213, null}
