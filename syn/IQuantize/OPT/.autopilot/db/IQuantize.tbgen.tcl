...
set C_modelArgList {
	...
	{ qmatrix int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "BUS_DST", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "matrix","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "matrix","bundle": "AXILiteS"},"direction": "READWRITE","cArray": [{"low" : 0,"up" : 63,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "qmatrix", "interface" : "axi_slave", "bundle":"BUS_CTRL","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":24}, "offset_end" : {"in":31}} ]}
...
set portList { 
	...
	{ m_axi_BUS_SRC_AWADDR sc_out sc_lv 32 signal 1 } 
	...
	{ m_axi_BUS_SRC_ARADDR sc_out sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "s_axi_BUS_CTRL_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "BUS_CTRL", "role": "AWADDR" },"address":[{"name":"IQuantize","role":"start","value":"0","valid_bit":"0"},{"name":"IQuantize","role":"continue","value":"0","valid_bit":"4"},{"name":"IQuantize","role":"auto_start","value":"0","valid_bit":"7"},{"name":"matrix","role":"data","value":"16"},{"name":"qmatrix","role":"data","value":"24"}] },
	...
	{ "name": "s_axi_BUS_CTRL_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "BUS_CTRL", "role": "ARADDR" },"address":[{"name":"IQuantize","role":"start","value":"0","valid_bit":"0"},{"name":"IQuantize","role":"done","value":"0","valid_bit":"1"},{"name":"IQuantize","role":"idle","value":"0","valid_bit":"2"},{"name":"IQuantize","role":"ready","value":"0","valid_bit":"3"},{"name":"IQuantize","role":"auto_start","value":"0","valid_bit":"7"}] },
