...
define void @IQuantize(i32* %matrix, i32* %qmatrix) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition(i32* %5, i32 1, i8* getelementptr inbounds ([7 x i8]* @.str715, i32 0, i32 0), i32 16, i8* getelementptr inbounds ([1 x i8]* @.str19, i32 0, i32 0)) nounwind, !dbg !223 ; [debug line = 174:1]
  %6 = getelementptr inbounds [32 x i32]* %inp2_buf, i32 0, i32 0, !dbg !224 ; [#uses=1 type=i32*] [debug line = 175:1]
  call void (...)* @_ssdm_SpecArrayPartition(i32* %6, i32 1, i8* getelementptr inbounds ([7 x i8]* @.str715, i32 0, i32 0), i32 16, i8* getelementptr inbounds ([1 x i8]* @.str19, i32 0, i32 0)) nounwind, !dbg !224 ; [debug line = 175:1]
...
; <label>:10                                      ; preds = %7
  call void @llvm.dbg.declare(metadata !{i32* %offset}, metadata !227), !dbg !229 ; [debug line = 186:11] [debug variable = offset]
  %11 = load i32* %i, align 4, !dbg !230          ; [#uses=1 type=i32] [debug line = 186:24]
  %12 = mul nsw i32 %11, 32, !dbg !230            ; [#uses=1 type=i32] [debug line = 186:24]
  store i32 %12, i32* %offset, align 4, !dbg !230 ; [debug line = 186:24]
  %13 = getelementptr inbounds [32 x i32]* %inp1_buf, i32 0, i32 0, !dbg !231 ; [#uses=1 type=i32*] [debug line = 187:4]
  %14 = bitcast i32* %13 to i8*, !dbg !231        ; [#uses=1 type=i8*] [debug line = 187:4]
  %15 = load i32** %2, align 8, !dbg !231         ; [#uses=1 type=i32*] [debug line = 187:4]
  %16 = load i32* %offset, align 4, !dbg !231     ; [#uses=1 type=i32] [debug line = 187:4]
  %17 = zext i32 %16 to i64, !dbg !231            ; [#uses=1 type=i64] [debug line = 187:4]
  %18 = getelementptr inbounds i32* %15, i64 %17, !dbg !231 ; [#uses=1 type=i32*] [debug line = 187:4]
  %19 = bitcast i32* %18 to i8*, !dbg !231        ; [#uses=1 type=i8*] [debug line = 187:4]
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %14, i8* %19, i64 128, i32 4, i1 false), !dbg !231 ; [debug line = 187:4]
  %20 = getelementptr inbounds [32 x i32]* %inp2_buf, i32 0, i32 0, !dbg !232 ; [#uses=1 type=i32*] [debug line = 188:4]
  %21 = bitcast i32* %20 to i8*, !dbg !232        ; [#uses=1 type=i8*] [debug line = 188:4]
  %22 = load i32** %1, align 8, !dbg !232         ; [#uses=1 type=i32*] [debug line = 188:4]
  %23 = load i32* %offset, align 4, !dbg !232     ; [#uses=1 type=i32] [debug line = 188:4]
  %24 = zext i32 %23 to i64, !dbg !232            ; [#uses=1 type=i64] [debug line = 188:4]
  %25 = getelementptr inbounds i32* %22, i64 %24, !dbg !232 ; [#uses=1 type=i32*] [debug line = 188:4]
  %26 = bitcast i32* %25 to i8*, !dbg !232        ; [#uses=1 type=i8*] [debug line = 188:4]
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %21, i8* %26, i64 128, i32 4, i1 false), !dbg !232 ; [debug line = 188:4]
  call void @llvm.dbg.declare(metadata !{i32* %k}, metadata !233), !dbg !235 ; [debug line = 193:13] [debug variable = k]
  store i32 0, i32* %k, align 4, !dbg !236        ; [debug line = 193:16]
  br label %27, !dbg !236                         ; [debug line = 193:16]

; <label>:27                                      ; preds = %43, %10
  %28 = load i32* %k, align 4, !dbg !236          ; [#uses=1 type=i32] [debug line = 193:16]
  %29 = icmp slt i32 %28, 32, !dbg !236           ; [#uses=1 type=i1] [debug line = 193:16]
  br i1 %29, label %30, label %46, !dbg !236      ; [debug line = 193:16]

; <label>:30                                      ; preds = %27
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0)) nounwind, !dbg !237 ; [debug line = 193:31]
  call void (...)* @_ssdm_Unroll(i32 1, i32 4, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str19, i32 0, i32 0)) nounwind, !dbg !239 ; [debug line = 194:1]
  %31 = load i32* %k, align 4, !dbg !240          ; [#uses=1 type=i32] [debug line = 195:2]
  %32 = sext i32 %31 to i64, !dbg !240            ; [#uses=1 type=i64] [debug line = 195:2]
  %33 = getelementptr inbounds [32 x i32]* %inp1_buf, i32 0, i64 %32, !dbg !240 ; [#uses=1 type=i32*] [debug line = 195:2]
  %34 = load i32* %33, align 4, !dbg !240         ; [#uses=1 type=i32] [debug line = 195:2]
  %35 = load i32* %k, align 4, !dbg !240          ; [#uses=1 type=i32] [debug line = 195:2]
  %36 = sext i32 %35 to i64, !dbg !240            ; [#uses=1 type=i64] [debug line = 195:2]
  %37 = getelementptr inbounds [32 x i32]* %inp2_buf, i32 0, i64 %36, !dbg !240 ; [#uses=1 type=i32*] [debug line = 195:2]
  %38 = load i32* %37, align 4, !dbg !240         ; [#uses=1 type=i32] [debug line = 195:2]
  %39 = mul nsw i32 %34, %38, !dbg !240           ; [#uses=1 type=i32] [debug line = 195:2]
  %40 = load i32* %k, align 4, !dbg !240          ; [#uses=1 type=i32] [debug line = 195:2]
  %41 = sext i32 %40 to i64, !dbg !240            ; [#uses=1 type=i64] [debug line = 195:2]
  %42 = getelementptr inbounds [32 x i32]* %inp2_buf, i32 0, i64 %41, !dbg !240 ; [#uses=1 type=i32*] [debug line = 195:2]
  store i32 %39, i32* %42, align 4, !dbg !240     ; [debug line = 195:2]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str11, i32 0, i32 0)) nounwind, !dbg !241 ; [debug line = 196:4]
  br label %43, !dbg !241                         ; [debug line = 196:4]

; <label>:43                                      ; preds = %30
  %44 = load i32* %k, align 4, !dbg !242          ; [#uses=1 type=i32] [debug line = 193:26]
  %45 = add nsw i32 %44, 1, !dbg !242             ; [#uses=1 type=i32] [debug line = 193:26]
  store i32 %45, i32* %k, align 4, !dbg !242      ; [debug line = 193:26]
  br label %27, !dbg !242                         ; [debug line = 193:26]

; <label>:46                                      ; preds = %27
  %47 = load i32* %i, align 4, !dbg !243          ; [#uses=1 type=i32] [debug line = 204:6]
  %48 = mul nsw i32 %47, 32, !dbg !243            ; [#uses=1 type=i32] [debug line = 204:6]
  store i32 %48, i32* %offset, align 4, !dbg !243 ; [debug line = 204:6]
  %49 = load i32** %1, align 8, !dbg !244         ; [#uses=1 type=i32*] [debug line = 205:6]
  %50 = load i32* %offset, align 4, !dbg !244     ; [#uses=1 type=i32] [debug line = 205:6]
  %51 = zext i32 %50 to i64, !dbg !244            ; [#uses=1 type=i64] [debug line = 205:6]
  %52 = getelementptr inbounds i32* %49, i64 %51, !dbg !244 ; [#uses=1 type=i32*] [debug line = 205:6]
  %53 = bitcast i32* %52 to i8*, !dbg !244        ; [#uses=1 type=i8*] [debug line = 205:6]
  %54 = getelementptr inbounds [32 x i32]* %inp2_buf, i32 0, i32 0, !dbg !244 ; [#uses=1 type=i32*] [debug line = 205:6]
  %55 = bitcast i32* %54 to i8*, !dbg !244        ; [#uses=1 type=i8*] [debug line = 205:6]
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %53, i8* %55, i64 128, i32 4, i1 false), !dbg !244 ; [debug line = 205:6]
  br label %56, !dbg !245                         ; [debug line = 207:2]
...
; <label>:59                                      ; preds = %7
  ret void, !dbg !247                             ; [debug line = 209:1]
}
...
!216 = metadata !{i32 786688, metadata !213, metadata !"i", metadata !73, i32 170, metadata !10, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!217 = metadata !{i32 170, i32 5, metadata !213, null}
!218 = metadata !{i32 786688, metadata !213, metadata !"inp1_buf", metadata !73, i32 171, metadata !219, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!221 = metadata !{i32 786688, metadata !213, metadata !"inp2_buf", metadata !73, i32 172, metadata !219, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!226 = metadata !{i32 786443, metadata !213, i32 177, i32 2, metadata !73, i32 8} ; [ DW_TAG_lexical_block ]
!227 = metadata !{i32 786688, metadata !228, metadata !"offset", metadata !73, i32 186, metadata !38, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!228 = metadata !{i32 786443, metadata !226, i32 177, i32 29, metadata !73, i32 9} ; [ DW_TAG_lexical_block ]
!229 = metadata !{i32 186, i32 11, metadata !228, null}
!230 = metadata !{i32 186, i32 24, metadata !228, null}
!231 = metadata !{i32 187, i32 4, metadata !228, null}
!232 = metadata !{i32 188, i32 4, metadata !228, null}
!233 = metadata !{i32 786688, metadata !234, metadata !"k", metadata !73, i32 193, metadata !10, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!234 = metadata !{i32 786443, metadata !228, i32 193, i32 4, metadata !73, i32 10} ; [ DW_TAG_lexical_block ]
!235 = metadata !{i32 193, i32 13, metadata !234, null}
!236 = metadata !{i32 193, i32 16, metadata !234, null}
!237 = metadata !{i32 193, i32 31, metadata !238, null}
!238 = metadata !{i32 786443, metadata !234, i32 193, i32 30, metadata !73, i32 11} ; [ DW_TAG_lexical_block ]
!239 = metadata !{i32 194, i32 1, metadata !238, null}
!240 = metadata !{i32 195, i32 2, metadata !238, null}
!241 = metadata !{i32 196, i32 4, metadata !238, null}
!242 = metadata !{i32 193, i32 26, metadata !234, null}
!243 = metadata !{i32 204, i32 6, metadata !228, null}
!244 = metadata !{i32 205, i32 6, metadata !228, null}
!245 = metadata !{i32 207, i32 2, metadata !228, null}
!246 = metadata !{i32 177, i32 25, metadata !226, null}
!247 = metadata !{i32 209, i32 1, metadata !213, null}
