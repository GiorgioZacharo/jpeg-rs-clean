...
#ifndef __IQuantize_mul_32sbkb__HH__
#define __IQuantize_mul_32sbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(IQuantize_mul_32sbkb) {
    ...
    SC_CTOR(IQuantize_mul_32sbkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
