...
entity IQuantize_BUS_CTRL_s_axi is
generic (
...
end entity IQuantize_BUS_CTRL_s_axi;
...
architecture behave of IQuantize_BUS_CTRL_s_axi is
    ...
    constant ADDR_QMATRIX_DATA_0 : INTEGER := 16#1c#;
    constant ADDR_QMATRIX_DATA_1 : INTEGER := 16#20#;
    constant ADDR_QMATRIX_CTRL   : INTEGER := 16#24#;
    ...
    signal int_qmatrix         : UNSIGNED(63 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_QMATRIX_DATA_0 =>
                        rdata_data <= RESIZE(int_qmatrix(31 downto 0), 32);
                    when ADDR_QMATRIX_DATA_1 =>
                        rdata_data <= RESIZE(int_qmatrix(63 downto 32), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    matrix               <= STD_LOGIC_VECTOR(int_matrix);
    qmatrix              <= STD_LOGIC_VECTOR(int_qmatrix);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_QMATRIX_DATA_0) then
                    int_qmatrix(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_qmatrix(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_QMATRIX_DATA_1) then
                    int_qmatrix(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_qmatrix(63 downto 32));
                end if;
            end if;
        end if;
    end process;
