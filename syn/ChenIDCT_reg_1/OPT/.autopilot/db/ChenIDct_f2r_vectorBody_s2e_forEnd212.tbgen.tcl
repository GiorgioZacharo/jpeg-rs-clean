set C_TypeInfoList {{ 
"ChenIDct_f2r_vectorBody_s2e_forEnd212" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"y": [[], {"array": [ {"scalar": "int"}, [64]]}] }],[],""]
}}
set moduleName ChenIDct_f2r_vectorBody_s2e_forEnd212
...
set C_modelName {ChenIDct_f2r_vectorBody_s2e_forEnd212}
...
set C_modelArgMapList {[ 
	{ "Name" : "BUS_SRC_DST", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "y","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "y","bundle": "AXILiteS"},"direction": "READWRITE","cArray": [{"low" : 0,"up" : 63,"step" : 1}]}]}]} , 
 	{ "Name" : "y", "interface" : "axi_slave", "bundle":"BUS_CTRL","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_BUS_CTRL_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "BUS_CTRL", "role": "AWADDR" },"address":[{"name":"ChenIDct_f2r_vectorBody_s2e_forEnd212","role":"start","value":"0","valid_bit":"0"},{"name":"ChenIDct_f2r_vectorBody_s2e_forEnd212","role":"continue","value":"0","valid_bit":"4"},{"name":"ChenIDct_f2r_vectorBody_s2e_forEnd212","role":"auto_start","value":"0","valid_bit":"7"},{"name":"y","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_BUS_CTRL_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "BUS_CTRL", "role": "ARADDR" },"address":[{"name":"ChenIDct_f2r_vectorBody_s2e_forEnd212","role":"start","value":"0","valid_bit":"0"},{"name":"ChenIDct_f2r_vectorBody_s2e_forEnd212","role":"done","value":"0","valid_bit":"1"},{"name":"ChenIDct_f2r_vectorBody_s2e_forEnd212","role":"idle","value":"0","valid_bit":"2"},{"name":"ChenIDct_f2r_vectorBody_s2e_forEnd212","role":"ready","value":"0","valid_bit":"3"},{"name":"ChenIDct_f2r_vectorBody_s2e_forEnd212","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		"CDFG" : "ChenIDct_f2r_vectorBody_s2e_forEnd212",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ChenIDct_f2r_vectorBody_s2e_forEnd212_BUS_CTRL_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ChenIDct_f2r_vectorBody_s2e_forEnd212_BUS_SRC_DST_m_axi_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ChenIDct_f2r_vectbkb_U1", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	ChenIDct_f2r_vectorBody_s2e_forEnd212 {
		BUS_SRC_DST {Type IO LastRead 11 FirstWrite 13}
