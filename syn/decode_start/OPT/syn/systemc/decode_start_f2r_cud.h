...
#ifndef __decode_start_f2r_cud__HH__
#define __decode_start_f2r_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(decode_start_f2r_cud) {
    ...
    SC_CTOR(decode_start_f2r_cud):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
