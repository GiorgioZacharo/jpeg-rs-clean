...
#ifndef __decode_start_f2r_bkb__HH__
#define __decode_start_f2r_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(decode_start_f2r_bkb) {
    ...
    SC_CTOR(decode_start_f2r_bkb):  ACMP_mul_us_U ("ACMP_mul_us_U") {
