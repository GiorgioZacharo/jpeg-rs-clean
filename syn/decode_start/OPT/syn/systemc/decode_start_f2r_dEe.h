...
#ifndef __decode_start_f2r_dEe__HH__
#define __decode_start_f2r_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(decode_start_f2r_dEe) {
    ...
    SC_CTOR(decode_start_f2r_dEe):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
