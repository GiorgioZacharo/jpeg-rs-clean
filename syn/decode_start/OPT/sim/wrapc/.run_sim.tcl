...
set ::env(LD_LIBRARY_PATH) /home/tools/Xilinx/Vivado/2017.4/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/tools/Xilinx/Vivado/2017.4/lnx64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/tools/Xilinx/Vivado/2017.4/lnx64/tools/fft_v9_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/tools/Xilinx/Vivado/2017.4/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/tools/Xilinx/Vivado/2017.4/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "decode_start_f2r_vectorPh_s2e_forBody96Preheader.autotvin.dat"
	set constFileTvOut       "decode_start_f2r_vectorPh_s2e_forBody96Preheader.autotvout.dat"
	set constFileHdlTvIn     "decode_start_f2r_vectorPh_s2e_forBody96Preheader.autohdltvin.dat"
	set constFileHdlTvOut    "decode_start_f2r_vectorPh_s2e_forBody96Preheader.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
