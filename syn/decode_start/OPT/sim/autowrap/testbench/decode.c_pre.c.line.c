...
#pragma line 66 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
void ChenIDct (int *x, int *y);
#pragma empty_line
int rgb_buf[4][3][64];
#pragma line 86 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
...
#pragma line 234 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
void
WriteBlock (int *store, int *p_out_vpos, int *p_out_hpos,
     unsigned char *p_out_buf)
{
...
#pragma empty_line
  for (int i = 0; i < 64/32; i++) {
#pragma line 379 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
...
#pragma line 420 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        offset = i*32 ;
...
#pragma empty_line
      for (i = 0; i < 64/32; i++)
      {
#pragma line 475 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        unsigned offset = i*32;
...
#pragma line 516 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        offset = i*32;
        memcpy(rgb_buf[p][0] + offset, out1_buf, 32 * sizeof(int));
        memcpy(rgb_buf[p][1] + offset, out2_buf, 32 * sizeof(int));
        memcpy(rgb_buf[p][2] + offset, out3_buf, 32 * sizeof(int));
...
#pragma line 656 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
