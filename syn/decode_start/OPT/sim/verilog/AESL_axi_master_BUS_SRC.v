...
//------------------------Parameter----------------------
`define TV_IN_BUS_SRC "../tv/cdatafile/c.decode_start_f2r_vectorPh_s2e_forBody96Preheader.autotvin_BUS_SRC.dat"
`define TV_OUT_BUS_SRC "../tv/rtldatafile/rtl.decode_start_f2r_vectorPh_s2e_forBody96Preheader.autotvout_BUS_SRC.dat"
...
parameter BUS_SRC_mem_depth = 32'd 512;
...
output [64 - 1 : 0] TRAN_BUS_SRC_y_buf;
output [64 - 1 : 0] TRAN_BUS_SRC_u_buf;
output [64 - 1 : 0] TRAN_BUS_SRC_v_buf;
input ready;
input done;
...
assign    TRAN_BUS_SRC_y_buf = y_buf;
assign    TRAN_BUS_SRC_u_buf = u_buf;
assign    TRAN_BUS_SRC_v_buf = v_buf;
...
initial begin : initialize_offset
  ...
  y_buf <= 0 * DATA_byte_num;
  u_buf <= 384 * DATA_byte_num;
  v_buf <= 448 * DATA_byte_num;
end
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > BUS_SRC_mem_depth) begin
                $display ("/home/giorgio/workspace/jpeg-rs-clean/syn/decode_start/OPT/sim/verilog/AESL_axi_master_BUS_SRC.v: Write request address %d exceed AXI master BUS_SRC array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, BUS_SRC_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > BUS_SRC_mem_depth) begin
                $display ("/home/giorgio/workspace/jpeg-rs-clean/syn/decode_start/OPT/sim/verilog/AESL_axi_master_BUS_SRC.v: Read request address %d exceed AXI master BUS_SRC array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, BUS_SRC_mem_depth); 
                $finish;
            end
