...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.decode_start_f2r_vectorPh_s2e_forBody96Preheader.autotvin_BUS_SRC.dat"
         "c.decode_start_f2r_vectorPh_s2e_forBody96Preheader.autotvin_y_buf.dat"
         "c.decode_start_f2r_vectorPh_s2e_forBody96Preheader.autotvin_u_buf.dat"
         "c.decode_start_f2r_vectorPh_s2e_forBody96Preheader.autotvin_v_buf.dat"
         "c.decode_start_f2r_vectorPh_s2e_forBody96Preheader.autotvin_rgb_buf.dat"
         "c.decode_start_f2r_vectorPh_s2e_forBody96Preheader.autotvout_BUS_DST.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.decode_start_f2r_vectorPh_s2e_forBody96Preheader.autotvout_BUS_DST.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
