...
module AESL_axi_master_BUS_DST (
    ...
    TRAN_BUS_DST_BID,
    TRAN_BUS_DST_BUSER,
    TRAN_BUS_DST_rgb_buf,
    ready,
    done
    );

//------------------------Parameter----------------------
`define TV_IN_BUS_DST "../tv/cdatafile/c.decode_start_f2r_vectorPh_s2e_forBody96Preheader.autotvin_BUS_DST.dat"
`define TV_OUT_BUS_DST "../tv/rtldatafile/rtl.decode_start_f2r_vectorPh_s2e_forBody96Preheader.autotvout_BUS_DST.dat"
...
parameter BUS_DST_C_DATA_BITWIDTH = 32'd 32;
parameter BUS_DST_mem_depth = 32'd 768;
...
output [64 - 1 : 0] TRAN_BUS_DST_rgb_buf;
input ready;
input done;
...
assign    TRAN_BUS_DST_rgb_buf = rgb_buf;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > BUS_DST_mem_depth) begin
                $display ("/home/giorgio/workspace/jpeg-rs-clean/syn/decode_start/OPT/sim/verilog/AESL_axi_master_BUS_DST.v: Write request address %d exceed AXI master BUS_DST array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, BUS_DST_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > BUS_DST_mem_depth) begin
                $display ("/home/giorgio/workspace/jpeg-rs-clean/syn/decode_start/OPT/sim/verilog/AESL_axi_master_BUS_DST.v: Read request address %d exceed AXI master BUS_DST array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, BUS_DST_mem_depth); 
                $finish;
            end
