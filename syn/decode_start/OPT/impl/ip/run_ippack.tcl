...
set Library     "hls"
set IPName      "decode_start_f2r_vectorPh_s2e_forBody96Preheader"
set Version     "1.0"
set DisplayName "Decode_start_f2r_vectorph_s2e_forbody96preheader"
set Revision    "1805152006"
...
## Variables
set Top "decode_start_f2r_vectorPh_s2e_forBody96Preheader"
...
set Interfaces {
    s_axi_BUS_CTRL {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 y_buf_1 W 0x0 "Data signal of y_buf" {{0 32 y_buf W 0 "Bit 31 to 0 Data signal of y_buf"}}} {0x14 y_buf_2 W 0x0 "Data signal of y_buf" {{0 32 y_buf W 0 "Bit 63 to 32 Data signal of y_buf"}}} {0x1c u_buf_1 W 0x0 "Data signal of u_buf" {{0 32 u_buf W 0 "Bit 31 to 0 Data signal of u_buf"}}} {0x20 u_buf_2 W 0x0 "Data signal of u_buf" {{0 32 u_buf W 0 "Bit 63 to 32 Data signal of u_buf"}}} {0x28 v_buf_1 W 0x0 "Data signal of v_buf" {{0 32 v_buf W 0 "Bit 31 to 0 Data signal of v_buf"}}} {0x2c v_buf_2 W 0x0 "Data signal of v_buf" {{0 32 v_buf W 0 "Bit 63 to 32 Data signal of v_buf"}}} {0x34 rgb_buf_1 W 0x0 "Data signal of rgb_buf" {{0 32 rgb_buf W 0 "Bit 31 to 0 Data signal of rgb_buf"}}} {0x38 rgb_buf_2 W 0x0 "Data signal of rgb_buf" {{0 32 rgb_buf W 0 "Bit 63 to 32 Data signal of rgb_buf"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_BUS_CTRL m_axi_BUS_SRC m_axi_BUS_DST"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_BUS_SRC {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_BUS_SRC"
        data_width "32"
        param_prefix "C_M_AXI_BUS_SRC"
        ...
        has_dependant_on "1"
        offset_slave_name "s_axi_BUS_CTRL"
    ...
    m_axi_BUS_DST {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_BUS_DST"
        data_width "32"
        param_prefix "C_M_AXI_BUS_DST"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 3 machine 64 combinational 0 latency 2017 II x}
