...
#ifndef __ChenIDct_mul_9ns_eOg__HH__
#define __ChenIDct_mul_9ns_eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ChenIDct_mul_9ns_eOg) {
    ...
    SC_CTOR(ChenIDct_mul_9ns_eOg):  ACMP_mul_us_U ("ACMP_mul_us_U") {
