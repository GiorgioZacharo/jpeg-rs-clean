...
#ifndef __ChenIDct_mul_10s_cud__HH__
#define __ChenIDct_mul_10s_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ChenIDct_mul_10s_cud) {
    ...
    SC_CTOR(ChenIDct_mul_10s_cud):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
