...
#ifndef __ChenIDct_mul_10nsdEe__HH__
#define __ChenIDct_mul_10nsdEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ChenIDct_mul_10nsdEe) {
    ...
    SC_CTOR(ChenIDct_mul_10nsdEe):  ACMP_mul_us_U ("ACMP_mul_us_U") {
