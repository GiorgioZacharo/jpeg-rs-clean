...
#ifndef __ChenIDct_mul_8ns_bkb__HH__
#define __ChenIDct_mul_8ns_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ChenIDct_mul_8ns_bkb) {
    ...
    SC_CTOR(ChenIDct_mul_8ns_bkb):  ACMP_mul_us_U ("ACMP_mul_us_U") {
