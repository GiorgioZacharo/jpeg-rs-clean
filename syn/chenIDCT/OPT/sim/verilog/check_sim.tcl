...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.ChenIDct.autotvin_BUS_SRC_DST.dat"
         "c.ChenIDct.autotvin_x.dat"
         "c.ChenIDct.autotvin_y.dat"
         "c.ChenIDct.autotvout_BUS_SRC_DST.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.ChenIDct.autotvout_BUS_SRC_DST.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
