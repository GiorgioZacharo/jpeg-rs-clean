...
#pragma line 70 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
void ChenIDct (int *x, int *y);
#pragma empty_line
int rgb_buf[4][3][64];
#pragma line 90 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
...
#pragma empty_line
#pragma empty_line
WriteOneBlock (int store[64], unsigned char out_buf[5310], int width, int height,
int voffs, int hoffs)
{
  int i, e;
#pragma empty_line
...
#pragma line 307 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
void
WriteBlock (int *store, int *p_out_vpos, int *p_out_hpos,
     unsigned char *p_out_buf)
{
...
#pragma empty_line
  for (int i = 0; i < 64/32; i++) {
#pragma line 452 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
...
#pragma line 493 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        offset = i*32 ;
...
#pragma empty_line
      for (i = 0; i < 64/32; i++)
      {
#pragma line 548 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        unsigned offset = i*32;
...
#pragma line 589 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        offset = i*32;
        memcpy(rgb_buf[p][0] + offset, out1_buf, 32 * sizeof(int));
        memcpy(rgb_buf[p][1] + offset, out2_buf, 32 * sizeof(int));
        memcpy(rgb_buf[p][2] + offset, out3_buf, 32 * sizeof(int));
...
#pragma line 729 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
