# 1 "/home/giorgio/workspace/jpeg-rs-clean/src/chenidct.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/giorgio/workspace/jpeg-rs-clean/src/chenidct.c"
# 54 "/home/giorgio/workspace/jpeg-rs-clean/src/chenidct.c"
# 1 "../../../inc/chenidct.h" 1
# 76 "../../../inc/chenidct.h"
void
ChenIDct (int *x, int *y);
# 55 "/home/giorgio/workspace/jpeg-rs-clean/src/chenidct.c" 2
# 1 "../../../inc/decode.h" 1
# 46 "../../../inc/decode.h"
# 1 "../../../inc/global.h" 1
# 45 "../../../inc/global.h"
...
# 56 "/home/giorgio/workspace/jpeg-rs-clean/src/chenidct.c" 2




void ChenIDct_f2r_vectorBody_s2e_forEnd212(int y[64]){
...
#pragma HLS ARRAY_PARTITION variable=out1_buf cyclic factor=16 dim=1
  ...
  for (i = 0; i < 64/32; i++){
# 81 "/home/giorgio/workspace/jpeg-rs-clean/src/chenidct.c"
...
# 98 "/home/giorgio/workspace/jpeg-rs-clean/src/chenidct.c"
      offset = i*32;
...
# 112 "/home/giorgio/workspace/jpeg-rs-clean/src/chenidct.c"
void
ChenIDct (int x[64], int y[64]) {
...
# 270 "/home/giorgio/workspace/jpeg-rs-clean/src/chenidct.c"
  int inp1_buf[32];
  int out1_buf[32];
...
#pragma HLS ARRAY_PARTITION variable=out1_buf cyclic factor=16 dim=1
  ...
  for (i = 0; i < 64/32; i++){
# 286 "/home/giorgio/workspace/jpeg-rs-clean/src/chenidct.c"
        unsigned offset = i*32;
        memcpy(inp1_buf, y + offset, 32 * sizeof(int));
...
#pragma HLS UNROLL skip_exit_check factor=16
      out1_buf[k] = (((inp1_buf[k] < 0) ? (inp1_buf[k] - 8) : (inp1_buf[k] + 8)) / 16);
# 303 "/home/giorgio/workspace/jpeg-rs-clean/src/chenidct.c"
      offset = i*32;
      memcpy(y + offset, out1_buf, 32 * sizeof(int));
