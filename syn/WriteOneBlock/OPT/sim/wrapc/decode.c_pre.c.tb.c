...
#70 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
void ChenIDct (int *x, int *y);

int rgb_buf[4][3][64];
#90 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
...
#307 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"

#ifndef HLS_FASTSIM
#include "apatb_WriteOneBlock_f2r_entry_s2e_forEnd13.h"
#endif
...
#ifndef HLS_FASTSIM
#define WriteOneBlock_f2r_entry_s2e_forEnd13 AESL_WRAP_WriteOneBlock_f2r_entry_s2e_forEnd13
#endif

#323 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
...
#undef WriteOneBlock_f2r_entry_s2e_forEnd13
#323 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
...
#361 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
...
#369 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
...
#378 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
...
#387 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
...
#pragma HLS ARRAY_PARTITION variable=out3_buf cyclic factor=16 dim=1
  ...
  for (int i = 0; i < 64/32; i++) {
#452 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
...
#493 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        offset = i*32 ;
...
#pragma HLS ARRAY_PARTITION variable=out3_buf cyclic factor=16 dim=1
      ...
      for (i = 0; i < 64/32; i++)
      {
#548 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        unsigned offset = i*32;
...
#589 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
        offset = i*32;
        memcpy(rgb_buf[p][0] + offset, out1_buf, 32 * sizeof(int));
        memcpy(rgb_buf[p][1] + offset, out2_buf, 32 * sizeof(int));
        memcpy(rgb_buf[p][2] + offset, out3_buf, 32 * sizeof(int));
...
#729 "/home/giorgio/workspace/jpeg-rs-clean/src/decode.c"
