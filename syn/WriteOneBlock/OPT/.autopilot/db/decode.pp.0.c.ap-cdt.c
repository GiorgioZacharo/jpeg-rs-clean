...
#pragma line 70 "../src/decode.c"
void ChenIDct (int *x, int *y);
#pragma empty_line
int rgb_buf[4][3][64];
#pragma line 90 "../src/decode.c"
...
int voffs, int hoffs)
{_ssdm_SpecArrayDimSize(out_buf,5310);_ssdm_SpecArrayDimSize(store,64);
  int i, e;
#pragma empty_line
#pragma empty_line
#pragma empty_line
