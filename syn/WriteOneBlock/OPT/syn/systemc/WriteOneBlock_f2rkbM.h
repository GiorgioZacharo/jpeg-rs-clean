...
#ifndef __WriteOneBlock_f2rkbM__HH__
#define __WriteOneBlock_f2rkbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WriteOneBlock_f2rkbM) {
    ...
    SC_CTOR(WriteOneBlock_f2rkbM):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
