...
entity WriteOneBlock_f2r_entry_s2e_forEnd13_CTRL_BUS_s_axi is
generic (
...
end entity WriteOneBlock_f2r_entry_s2e_forEnd13_CTRL_BUS_s_axi;
...
architecture behave of WriteOneBlock_f2r_entry_s2e_forEnd13_CTRL_BUS_s_axi is
    ...
    constant ADDR_VOFFS_DATA_0  : INTEGER := 16#20#;
    constant ADDR_VOFFS_CTRL    : INTEGER := 16#24#;
    constant ADDR_HOFFS_DATA_0  : INTEGER := 16#28#;
    constant ADDR_HOFFS_CTRL    : INTEGER := 16#2c#;
    ...
    signal int_voffs           : UNSIGNED(31 downto 0) := (others => '0');
    signal int_hoffs           : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_VOFFS_DATA_0 =>
                        rdata_data <= RESIZE(int_voffs(31 downto 0), 32);
                    when ADDR_HOFFS_DATA_0 =>
                        rdata_data <= RESIZE(int_hoffs(31 downto 0), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    voffs                <= STD_LOGIC_VECTOR(int_voffs);
    hoffs                <= STD_LOGIC_VECTOR(int_hoffs);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_VOFFS_DATA_0) then
                    int_voffs(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_voffs(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_HOFFS_DATA_0) then
                    int_hoffs(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_hoffs(31 downto 0));
                end if;
            end if;
        end if;
    end process;
