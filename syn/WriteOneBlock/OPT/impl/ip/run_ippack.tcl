...
set Library     "hls"
set IPName      "WriteOneBlock_f2r_entry_s2e_forEnd13"
set Version     "1.0"
set DisplayName "Writeoneblock_f2r_entry_s2e_forend13"
set Revision    "1805041813"
...
## Variables
set Top "WriteOneBlock_f2r_entry_s2e_forEnd13"
...
set Interfaces {
    s_axi_BUS_CTRL {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 store_1 W 0x0 "Data signal of store" {{0 32 store W 0 "Bit 31 to 0 Data signal of store"}}} {0x14 store_2 W 0x0 "Data signal of store" {{0 32 store W 0 "Bit 63 to 32 Data signal of store"}}} {0x1c out_buf_1 W 0x0 "Data signal of out_buf" {{0 32 out_buf W 0 "Bit 31 to 0 Data signal of out_buf"}}} {0x20 out_buf_2 W 0x0 "Data signal of out_buf" {{0 32 out_buf W 0 "Bit 63 to 32 Data signal of out_buf"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    s_axi_CTRL_BUS {
        ...
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {{0x10 width W 0x0 "Data signal of width" {{0 32 width W 0 "Bit 31 to 0 Data signal of width"}}} {0x18 height W 0x0 "Data signal of height" {{0 32 height W 0 "Bit 31 to 0 Data signal of height"}}} {0x20 voffs W 0x0 "Data signal of voffs" {{0 32 voffs W 0 "Bit 31 to 0 Data signal of voffs"}}} {0x28 hoffs W 0x0 "Data signal of hoffs" {{0 32 hoffs W 0 "Bit 31 to 0 Data signal of hoffs"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_BUS_CTRL s_axi_CTRL_BUS m_axi_BUS_SRC m_axi_BUS_DST"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
