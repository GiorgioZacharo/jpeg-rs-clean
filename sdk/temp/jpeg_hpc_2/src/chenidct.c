...
void ChenIDct_f2r_vectorBody_s2e_forEnd212(int y[DCTSIZE2]){
  ...
  XChenidct_f2r_vectorbody_s2e_forend212_Set_y(&Chenidct_f2r_vectorbody_s2e_forend212_hpc, (UINTPTR)y);


  XChenidct_f2r_vectorbody_s2e_forend212_Start(&Chenidct_f2r_vectorbody_s2e_forend212_hpc);

  while (!XChenidct_f2r_vectorbody_s2e_forend212_IsDone(&Chenidct_f2r_vectorbody_s2e_forend212_hpc));
...
ChenIDct (int x[DCTSIZE2], int y[DCTSIZE2]) {
  ...
  XChenidct_Set_x(&Chenidct_hpc, (UINTPTR)x);
  XChenidct_Set_y(&Chenidct_hpc, (UINTPTR)y);


  XChenidct_Start(&Chenidct_hpc);

  while (!XChenidct_IsDone(&Chenidct_hpc));
